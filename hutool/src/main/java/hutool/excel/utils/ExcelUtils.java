...
public class ExcelUtils {
    ...
    public static void exportNoHead(Set<String> ignoreFields, List<?> rows,OutputStream out, boolean isXlsx, List<MergeModel> mergeModels){
        export(defineHeadsByBean(rows.get(0).getClass(),ignoreFields),rows,out,isXlsx,mergeModels);
    }
     ...
     * @param ignoreFields 需忽略的的实体属性
     */
    public static Map<String,String> defineHeadsByBean(Class<?> type, Set<String> ignoreFields){
